...
public class ResourceSupport {
    ...
    static final Integer AUTO_RESOURCING = 2; //QualitasCorpus.class: Modified from int to Integer
    static final Integer AUTO_INJECTION = 3; //QualitasCorpus.class: Modified from int to Integer
