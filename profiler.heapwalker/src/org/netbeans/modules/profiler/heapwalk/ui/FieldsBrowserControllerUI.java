...
public class FieldsBrowserControllerUI extends JTitledPanel {
    ...
    public FieldsBrowserControllerUI(FieldsBrowserController fieldsBrowserController) {
        super((String) ((fieldsBrowserController.getRootMode() == FieldsBrowserController.ROOT_INSTANCE) ? 
    ...
    private JPopupMenu createTablePopup() {
        ...
        // Show Instance
        showInstanceItem = new JMenuItem((Icon) ((fieldsBrowserController.getRootMode() == FieldsBrowserController.ROOT_INSTANCE)
        ...
        showClassItem = new JMenuItem((Icon) ((fieldsBrowserController.getRootMode() == FieldsBrowserController.ROOT_INSTANCE)
    ...
    private void initComponents() {
        ...
        String hintText = (String) ((fieldsBrowserController.getRootMode() == FieldsBrowserController.ROOT_INSTANCE)
