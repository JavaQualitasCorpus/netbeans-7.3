...
public class MavenWizardIterator implements WizardDescriptor.BackgroundInstantiatingIterator<WizardDescriptor> {
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private static String LBL_Maven_Quickstart_Archetype() {
	...
	//QualitasCorpus.class: Created due to compilation errors
    private static String LBL_Maven_POM_Archetype() {
		// TODO Auto-generated method stub
		return null;
	}
  ...
  //QualitasCorpus.class: Created due to compilation errors
  private String LBL_CreateProjectStep2() {
		// TODO Auto-generated method stub
		return null;
	}

	//QualitasCorpus.class: Created due to compilation errors
    private String LBL_CreateProjectStep() {
		// TODO Auto-generated method stub
		return null;
	}
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private String NameFormat(int i, int size) {
		// TODO Auto-generated method stub
		return null;
	}
