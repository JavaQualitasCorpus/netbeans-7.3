...
public class TemplatesPanel extends TopComponent implements ExplorerManager.Provider {
    ...
    private static class RenameTemplateAction extends AbstractAction implements HelpCtx.Provider {
        ...
        public Object getValue(String key) {
            if (Action.NAME.equals(key)) {
                return null; //Action_Rename(); //QualitasCorpus.class: Removed due to compilation errors
            }
    ...
    private static Sheet.Set createTemplateProperties (final TemplateNode templateNode) {
        ...
        properties.put (new PropertySupport.ReadWrite<String> (
                    ...
                    String.class,
                    null, //TemplatesPanel_TemplateNode_DisplayName(), //QualitasCorpus.class: Removed due to compilation errors
                    null //TemplatesPanel_TemplateNode_DisplayName_Desc() //QualitasCorpus.class: Removed due to compilation errors
                ) {
                    @Override
        ...
        properties.put (new PropertySupport.ReadWrite<String> (
                    ...
                    String.class,
                    null, //TemplatesPanel_TemplateNode_FileName(), //QualitasCorpus.class: Removed due to compilation errors
                    null //TemplatesPanel_TemplateNode_FileName_Desc() //QualitasCorpus.class: Removed due to compilation errors
                ) {
                    @Override
                    public String getValue () throws IllegalAccessException, InvocationTargetException {
        ...
        if (getDOFromNode(templateNode).getPrimaryFile().getPath().startsWith(LICENSES_FOLDER + "/")) {
        	...
        	properties.put(new PropertySupport.ReadWrite<String>(TEMPLATE_LICENSE_URL_ATTRIBUTE, String.class, null, null) {
        ...
        properties.put (new PropertySupport.ReadWrite<String> (
                    ...
                    String.class,
                    null, //TemplatesPanel_TemplateNode_ScriptEngine(), //QualitasCorpus.class: Removed due to compilation errors
                    null//TemplatesPanel_TemplateNode_ScriptEngine_Desc() //QualitasCorpus.class: Removed due to compilation errors
                ) {
                    @Override
                    public String getValue () throws IllegalAccessException, InvocationTargetException {
        ...
        properties.put (new PropertySupport.ReadWrite<String []> (
                    ...
                    String [].class,
                    null, //TemplatesPanel_TemplateNode_TemplateCategories(), //QualitasCorpus.class: Removed due to compilation errors
                    null//TemplatesPanel_TemplateNode_TemplateCategories_Desc() //QualitasCorpus.class: Removed due to compilation errors
                ) {
                    @Override
                    public String [] getValue () throws IllegalAccessException, InvocationTargetException {
                        DataObject dobj = getDOFromNode (templateNode);
      ...
      //QualitasCorpus.class: Removed due to compilation errors
        ...
        if (JFileChooser.APPROVE_OPTION == result) {
            ...
            if (! f.isFile()) {
            	...
            	NotifyDescriptor.Message msg = new NotifyDescriptor.Message(null);
    ...
    private static DataFolder doNewFolder (Node [] nodes) {
        ...
        String baseName = null; //TXT_TemplatesPanel_NewFolderName(); //QualitasCorpus.class: Removed due to compilation errors
    ...
    private static void showRename(TemplateNode n) {
        ...
        String title = null; //RenameTemplatePanel_title_text();//QualitasCorpus.class: Removed due to compilation errors
    ...
    private static class AddAction extends NodeAction {
        ...
        @Override public String getName() {
            //return BTN_TemplatesPanel_Add(); //QualitasCorpus.class: Removed due to compilation errors
        	return null;
        }
