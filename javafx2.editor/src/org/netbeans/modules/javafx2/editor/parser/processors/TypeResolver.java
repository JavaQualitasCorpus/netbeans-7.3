...
public class TypeResolver extends FxNodeVisitor.ModelTreeTraversal implements ModelBuilderStep {
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private String ERR_unableAnalyseClass(String string) {
	...
	//QualitasCorpus.class: Created due to compilation errors
    private String ERR_factoryTypeNotFound(String fM, String string) {
		// TODO Auto-generated method stub
		return null;
	}

  //QualitasCorpus.class: Created due to compilation errors
	private String ERR_notFxInstance(String string) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	//QualitasCorpus.class: Created due to compilation errors
    private String ERR_symbolAmbiguous(String name, String next, String next2) {
		// TODO Auto-generated method stub
		return null;
	}

  //QualitasCorpus.class: Created due to compilation errors
	private String ERR_symbolNotExist(String name) {
		// TODO Auto-generated method stub
		return null;
	}

	//QualitasCorpus.class: Created due to compilation errors
	private String ERR_invalidJavaIdentifier(String name) {
		// TODO Auto-generated method stub
		return null;
	}
