...
public class IncludeResolver extends FxNodeVisitor.ModelTreeTraversal implements ModelBuilderStep {
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private String ERR_unresolvedIncludePath(String srcPath) {
		// TODO Auto-generated method stub
		return null;
	}

  //QualitasCorpus.class: Created due to compilation errors
	private String ERR_invalidSourcePath(String srcPath, String localizedMessage) {
		// TODO Auto-generated method stub
		return null;
	}

	//QualitasCorpus.class: Created due to compilation errors
	private String ERR_emptyIncludePath() {
		// TODO Auto-generated method stub
		return null;
	}
