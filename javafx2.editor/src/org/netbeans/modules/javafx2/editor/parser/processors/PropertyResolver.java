...
public class PropertyResolver extends FxNodeVisitor.ModelTreeTraversal implements ModelBuilderStep {
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private String ERR_attachedPropertyNotExist(String resolvedName, String propName) {
		// TODO Auto-generated method stub
		return null;
	}

  //QualitasCorpus.class: Created due to compilation errors
	private String ERR_unableAnalyseClass(String resolvedName) {
		// TODO Auto-generated method stub
		return null;
	}

	//QualitasCorpus.class: Created due to compilation errors
	private String ERR_sourceAttachClassAmbiguous(String sourceClassName, String next, String next2) {
		// TODO Auto-generated method stub
		return null;
	}

	//QualitasCorpus.class: Created due to compilation errors
	private String ERR_undefinedSourceAttachClass(String sourceClassName) {
		// TODO Auto-generated method stub
		return null;
	}
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private String ERR_defaultPropertyClash(String name) {
		// TODO Auto-generated method stub
		return null;
	}

  //QualitasCorpus.class: Created due to compilation errors
	private String ERR_noDefaultProperty(String className) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	//QualitasCorpus.class: Created due to compilation errors
    private String ERR_propertyNotExist(String className, String propName) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	//QualitasCorpus.class: Created due to compilation errors
    private String ERR_propertyHasAttributes(String propName) {
		// TODO Auto-generated method stub
		return null;
	}
