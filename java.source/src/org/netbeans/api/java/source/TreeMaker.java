...
public final class TreeMaker {
     ...
     */
    public MethodTree Constructor(ModifiersTree modifiers,
//                             List<? extends TypeParameterTree> typeParameters, //QualitasCorpus.class: removed generics due to compilation errors
//                             List<? extends VariableTree> parameters, //QualitasCorpus.class: removed generics due to compilation errors
//                             List<? extends ExpressionTree> throwsList, //QualitasCorpus.class: removed generics due to compilation errors
                             List typeParameters,
                             List parameters,
                             List throwsList,
                             String bodyText) {
    ...
    public MethodTree Method(ModifiersTree modifiers,
                      CharSequence name,
                      Tree returnType,
                      //QualitasCorpus.class: removed generics due to compilation errors
//                      List<? extends TypeParameterTree> typeParameters, 
//                      List<? extends VariableTree> parameters,
//                      List<? extends ExpressionTree> throwsList,
                      List typeParameters, 
     ...
     */
    //public ModifiersTree Modifiers(Set<Modifier> flags, List<? extends AnnotationTree> annotations) { //QualitasCorpus.class: removed generics due to compilation errors
