...
public final class JaxWsModelImpl implements JaxWsModel {
    ...
    public Boolean getJsr109() {
    	//QualitasCorpus.class: Modified due to compilation errors
        return (Boolean) (jaxws == null ? null : jaxws.getJsr109());
    }
    ...
    throws ServiceAlreadyExistsExeption {
      ...
      //QualitasCorpus.class: Modified due to compilation errors
        org.netbeans.modules.websvc.jaxwsmodel.project_config1_0.Service service = ((Services) jaxws.getServices()).newService();
    ...
    public synchronized void addPropertyChangeListener(PropertyChangeListener l) {
        if (jaxws == null) {
          ...
          //QualitasCorpus.class: Modified due to compilation errors
            ((Bean) jaxws).addPropertyChangeListener(jaxWsPcl);
        }
    }
