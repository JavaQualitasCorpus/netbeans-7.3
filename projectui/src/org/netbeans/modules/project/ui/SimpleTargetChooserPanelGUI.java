...
public class SimpleTargetChooserPanelGUI extends javax.swing.JPanel implements ActionListener, DocumentListener {
    ...
    final void initValues(FileObject template, FileObject preselectedFolder, String documentName) {
        ...
        if (template != null) {
            final String baseName = (String) (isFolder ? LBL_folder_name() : LBL_SimpleTargetChooserPanelGUI_NewFilePrefix() + template.getName ());
  ...
  //QualitasCorpus.class: Created due to compilation errors
  private String LBL_SimpleTargetChooserPanelGUI_NewFilePrefix() {
		// TODO Auto-generated method stub
		return null;
	}

	//QualitasCorpus.class: Created due to compilation errors
    private Object LBL_folder_name() {
		// TODO Auto-generated method stub
		return null;
	}
