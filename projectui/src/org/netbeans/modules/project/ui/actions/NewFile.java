...
public class NewFile extends ProjectAction implements PropertyChangeListener, Popup {
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private static String LBL_NewFileAction_Name() {
        ...
        RP.post(new Runnable() {
            @Override public void run() {
                ...
                EventQueue.invokeLater(new Runnable() {
                  ...
                  //QualitasCorpus.class: Created due to compilation errors
					private String LBL_NewFileAction_File_PopupName() {
						// TODO Auto-generated method stub
						return null;
					}
                });
  ...
  //QualitasCorpus.class: Created due to compilation errors
    private String LBL_NewFileAction_Template_PopupName(String displayName) {
		// TODO Auto-generated method stub
		return null;
	}
    ...
    public static final class WithSubMenu extends NewFile {
      ...
      //QualitasCorpus.class: Created due to compilation errors
        private String LBL_NewFileAction_PopupName() {
			// TODO Auto-generated method stub
			return null;
		}
